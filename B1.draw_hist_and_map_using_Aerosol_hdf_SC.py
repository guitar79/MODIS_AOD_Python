                ...
                try:
                    ...
                    with open("{}.csv".format(self.fullname[:(self.fullname.find(self.fullname_el[3]) - 1)]),
                        ...
                        if SET_MariaDB == True:
                            ...
                            self.plt_hist = _MODIS_AOD_utilities.draw_histogram_hdf(self.hdf_value, self.longitude,
                            ...
                            self.plt_map = _MODIS_AOD_utilities.draw_map_MODIS_hdf_onefile(self.hdf_value,
